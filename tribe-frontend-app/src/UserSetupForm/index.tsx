...
import UserSetupStep6 from '../UserSetupStep6';
...
function UserSetupForm() {
  ...
  const INITIAL_FAMILY_VALUES = { familyId: null, familyName: "" };
  ...
  return (
    <div className="UserSetupForm">
      ...
      <UserSetupStep3 value={formData.isParent} handleChange={handleChange} handleSubmit={handleSubmit} next={next} prev={prev} currentStep={currentStep} />
      <UserSetupStep4 setHasFamilyId={setHasFamilyId} next={next} currentStep={currentStep} />
      <UserSetupStep5 famIdValue={newFamData.familyId} famNameValue={newFamData.familyName} hasFamilyId={hasFamilyId} handleChange={handleChange} handleSubmit={handleSubmit} next={next} prev={prev} currentStep={currentStep} />
